...
pushd "%~dp0"
if "%~1"=="" (
  start javaw -classpath "%CLASSPATH%;classes;lib/Hack.jar;lib/HackGUI.jar;lib/Simulators.jar;lib/SimulatorsGUI.jar;lib/Compilers.jar" ^
    CPUEmulatorMain
) else (
rem  echo Running "%_arg1%"
  java -classpath "%CLASSPATH%;classes;lib/Hack.jar;lib/HackGUI.jar;lib/Simulators.jar;lib/SimulatorsGUI.jar;lib/Compilers.jar" ^
