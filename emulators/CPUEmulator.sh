...
then
	...
	java -classpath "${CLASSPATH}:classes:lib/Hack.jar:lib/HackGUI.jar:lib/Simulators.jar:lib/SimulatorsGUI.jar:lib/Compilers.jar" CPUEmulatorMain &
else
...
#	echo Running "$arg1"
	java -classpath "${CLASSPATH}:classes:lib/Hack.jar:lib/HackGUI.jar:lib/Simulators.jar:lib/SimulatorsGUI.jar:lib/Compilers.jar" CPUEmulatorMain "$arg1"
fi
